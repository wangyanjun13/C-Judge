      ...
      <nav class="nav">
        ...
        <div class="dropdown">
          ...
          <div class="dropdown-content">
            <router-link to="/admin/management?tab=classes" class="dropdown-item">班级管理</router-link>
            <router-link to="/admin/management?tab=teachers" class="dropdown-item">教师管理</router-link>
            <router-link to="/admin/management?tab=courses" class="dropdown-item">课程竞赛</router-link>
            <router-link to="/admin/management?tab=students" class="dropdown-item">学生管理</router-link>
          </div>
        </div>
        ...
        <div class="dropdown">
          ...
          <div class="dropdown-content">
            ...
            <router-link to="/admin/maintenance?tab=tags" class="dropdown-item">标签管理</router-link>
          </div>
        </div>
        ...
        <div class="dropdown">
          ...
          <div class="dropdown-content">
            <router-link to="/admin/system?tab=password" class="dropdown-item">修改密码</router-link>
            <router-link to="/admin/system?tab=statistics" class="dropdown-item">统计数据</router-link>
            <router-link to="/admin/system?tab=settings" class="dropdown-item">系统设置</router-link>
